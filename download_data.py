...
#     print(f"Downloading data for {from_currency}/{to_currency}...")
...
# # Download data for popular forex pairs
# def download_multiple_forex(pairs):
#     results = {}
...
#     # List of forex pairs to download
#     forex_pairs = [
...
#     results = download_multiple_forex(forex_pairs)
    
#     print("\nDownload Summary:")
#     for pair, file_path in results.items():
#         print(f"✅ {pair}: {file_path}")
    
#     print("\nForex data download complete. You can now upload these files to SCEF.")
